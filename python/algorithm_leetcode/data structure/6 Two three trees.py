...
'Source from https://www.youtube.com/watch?v=vSbBB4MRzp4&list=PLj8W7XIvO93qsmdxbaDpIvM1KCyNO1K_c&index=9'
class Node:
    ...
    def _add(self, new_node):
        print("Node_add: " + str(new_node.data) + ' to ' + str(self.data))
...
lst = [13, 7, 24, 15, 4, 29, 20, 16, 19, 1, 5]
for item in lst:
    tree.insert(item)
tree.printTop2Tiers()