...
class Learning:
    ...
    def __init__(self, once_ = 45*60, interval=1, web="https://www.baidu.com/", counts=2, music=False, stop = False, freq=0):
        # 初始化
        # once_ = 2 # 初始化一次学习45 min
        self.once_ = once_  # 间隔时间
        self.interval = interval * self.once_  # 学习时间
        self.web = web  # 开启网页
    ...
    def start_(self):
        ...
        while self.freq < self.counts:
            ...
            if self.music == True:
                self.play_music()
            self.freq += 1
            print("今日已学习 {} 次（{}分钟/次）".format(self.freq, self.interval))
    ...
    def play_music(self):
        ...
        pygame.mixer.init()
        # 设置 要播放音乐的绝对路径
        music1 = "D:\东蒙 人工智能课程\cs learning git\python\Project\弹窗项目\Music\m1.mp3"
        music2 = "D:\东蒙 人工智能课程\cs learning git\python\Project\弹窗项目\Music\句号.mp3"
        if (j == 0):
