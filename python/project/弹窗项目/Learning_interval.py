...
class Learning:
    ...
    def __init__(self, once_ = 1, interval=1, web="https://www.baidu.com/", counts=2, music=False, stop = False, freq=0):
        # 初始化
    ...
    def play_music(self):
        ...
        pygame.mixer.init()
        # 设置 要播放音乐的绝对路径
        music1 = "D:\东蒙 人工智能课程\cs learning git\python\Project\弹窗项目\Music\骄傲的少年.mp3"
        music2 = "D:\东蒙 人工智能课程\cs learning git\python\Project\弹窗项目\Music\句号.mp3.mp3"
        if (j == 0):
